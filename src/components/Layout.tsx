        ...
        <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-gray-600">
            ...
            <div className="relative group">
              ...
              <div className="absolute top-full left-0 w-48 bg-white border border-gray-100 rounded-xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all transform translate-y-2 group-hover:translate-y-0 z-50">
                <div className="flex flex-col p-2">
                  <button onClick={() => scrollToSection('our-purpose')} className="text-left px-4 py-2.5 hover:bg-orange-50 rounded-lg font-bold hover:text-orange-600 transition-colors">Our Purpose</button>
                  <button onClick={() => scrollToSection('why-we-serve')} className="text-left px-4 py-2.5 hover:bg-orange-50 rounded-lg font-bold hover:text-orange-600 transition-colors">Why We Serve</button>
                  <button onClick={() => scrollToSection('why-freshlink')} className="text-left px-4 py-2.5 hover:bg-orange-50 rounded-lg font-bold hover:text-orange-600 transition-colors">Why OpenTable</button>
                  <button onClick={() => scrollToSection('annual-reports')} className="text-left px-4 py-2.5 hover:bg-orange-50 rounded-lg font-bold hover:text-orange-600 transition-colors">Annual Reports</button>
                </div>
              </div>
            </div>
            ...
            <div className="relative group">
              ...
              <div className="absolute top-full left-0 w-48 bg-white border border-gray-100 rounded-xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all transform translate-y-2 group-hover:translate-y-0 z-50">
                <div className="flex flex-col p-2">
                  <button onClick={() => scrollToSection('major-donations')} className="text-left px-4 py-2.5 hover:bg-orange-50 font-bold rounded-lg hover:text-orange-600 transition-colors">Major Donations</button>
                  <button onClick={() => scrollToSection('how-we-help')} className="text-left px-4 py-2.5 hover:bg-orange-50 font-bold rounded-lg hover:text-orange-600 transition-colors">How We Help</button>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <img src="/logo.png" alt="OpenTable Logo" className="w-8 h-8 object-contain rounded-lg shadow-sm bg-white" />
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-500 font-medium">
              <li><button onClick={() => scrollToSection('our-purpose')} className="hover:text-orange-500 transition-colors">Our Purpose</button></li>
              <li><button onClick={() => scrollToSection('why-we-serve')} className="hover:text-orange-500 transition-colors">Why We Serve</button></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-500 font-medium">
              <li><button onClick={() => navigate('/login')} className="hover:text-orange-500 transition-colors">Donate Food</button></li>
              <li><button onClick={() => navigate('/login')} className="hover:text-orange-500 transition-colors">Become a Volunteer</button></li>
            </ul>
          </div>
