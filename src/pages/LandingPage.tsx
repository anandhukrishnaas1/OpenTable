    ...
    <Layout>
        ...
        <div className="max-w-6xl mx-auto px-6 py-20 md:py-32 grid md:grid-cols-2 gap-12 items-center relative z-10">
          <div className="space-y-6 animate-in slide-in-from-left duration-700">
            ...
            <p className="text-lg text-gray-600 max-w-md leading-relaxed font-medium">
              OpenTable empowers communities by seamlessly connecting surplus, perfectly good food
              with local NGOs and shelters. Our platform ensures safety, dignity, and care in every
              donation.
            </p>
      ...
      <div className="bg-gray-50 py-24 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 space-y-20 relative z-10">
          ...
          <section
            id="our-purpose"
            className="scroll-mt-24 bg-white p-10 md:p-14 rounded-[2.5rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100/50"
          >
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              OpenTable was founded with a simple yet powerful mission: to eliminate food waste
              while addressing hunger in our communities. Every day, tons of perfectly good food is
              discarded by restaurants, grocery stores, and households while millions of people
              struggle to find their next meal.
            </p>
            <p className="text-gray-600 leading-relaxed">
              Our platform uses cutting-edge AI technology to make food donation effortless and
              safe. By connecting donors directly with NGOs and food banks, we ensure that surplus
              food reaches those who need it most, quickly and efficiently.
            </p>
          </section>
          ...
          >
            ...
            <p className="text-gray-600 leading-relaxed mb-8">
              We serve because we believe in the power of community. Food insecurity affects
              families, children, and elderly individuals in every neighborhood. By making food
              donation accessible and simple, we empower everyone to make a difference.
            </p>
          ...
          >
            ...
            <p className="text-gray-600 mb-6">
              OpenTable stands apart because we combine technology with compassion. Our AI-powered
              food analysis ensures only safe, quality food is donated, protecting both donors and
              recipients.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Instant analysis ensures food is safe for donation',
                },
                { title: 'Real-time Tracking', desc: 'Know exactly where your donation goes' },
                {
                  title: 'Local Impact',
                  desc: 'Connect with NGOs and food banks in your community',
                },
            ...
            <div className="space-y-8">
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-bold text-gray-900 flex items-center gap-2">
                    <Camera size={18} /> Snap & Analyze
                  </h3>
                  <p className="text-sm text-gray-500 mt-1">
                    Donors take a photo of their food. Our AI instantly analyzes safety, freshness,
                    and categorizes the donation.
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-bold text-gray-900 flex items-center gap-2">
                    <Users size={18} /> Volunteer Accepts
                  </h3>
                  <p className="text-sm text-gray-500 mt-1">
                    Local volunteers receive notifications about available donations and accept
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    Volunteers collect the food and deliver it to partner NGOs, food banks, or
                    shelters.
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-bold text-gray-900 flex items-center gap-2">
                    <Activity size={18} /> Impact Tracked
                  </h3>
                  <p className="text-sm text-gray-500 mt-1">
                    Every donation is tracked from pickup to delivery. Donors receive updates on the
                    real impact of their contribution.
                  </p>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <p className="text-gray-600 mb-8">
              We believe in transparency and accountability. Our annual reports detail our impact,
              financials, and plans for the future.
            </p>
            <div className="bg-gray-50 rounded-2xl p-8 text-center border border-dashed border-gray-300">
              ...
              <p className="text-sm text-gray-500">
                As a new initiative, we are working to compile our first comprehensive report.
              </p>
            </div>
          </section>
                ...
                donations.slice(0, 6).map((d) => {
                  ...
                  if (d.timestamp) {
                    ...
                    if (diffSec < 60) timeDisplay = 'Just now';
                      ...
                      timeDisplay = `${Math.floor(diffSec / 3600)} hours ago`;
                  ...
                  return (
                    <div
                      key={d.id}
                      className="bg-gray-50 p-6 rounded-2xl border border-gray-100 flex flex-col items-center text-center hover:shadow-md transition-all hover:-translate-y-1"
                    >
                      <div className="text-4xl mb-3">{iconDisplay}</div>
                      <h3 className="font-bold text-gray-900">{d.donorType || 'Generous Donor'}</h3>
                      <p className="text-green-600 font-medium text-sm my-1">
                        {d.quantity} {d.item}
                      </p>
