        ...
        <Layout>
            ...
            <div className="max-w-2xl mx-auto px-4 py-8">
                <div className="mb-8">
                    ...
                    <p className="text-gray-500">To maintain trust in our community, we require all our volunteers to verify their identity.</p>
                </div>
                ...
                {existingApplication && existingApplication.status === 'Verified' ? (
                    <div className="bg-green-50 rounded-[2rem] p-10 text-center border border-green-200">
                        ...
                        <p className="text-gray-600 mb-8 max-w-md mx-auto">
                            Your account is fully approved! You can now start accepting food pickup requests across the city.
                        </p>
                        <button onClick={() => navigate('/volunteer')} className="bg-green-600 text-white font-bold py-4 px-8 rounded-full shadow-lg hover:bg-green-700 transition">
                            Go to Volunteer Dashboard
                        </button>
                    </div>
                ) : existingApplication && (existingApplication.status === 'Pending' || existingApplication.status === 'Flagged') ? (
                    <div className="bg-white rounded-[2rem] p-10 text-center border border-gray-100 shadow-sm mt-8">
                        ...
                        <p className="text-gray-600 max-w-md mx-auto">
                            Thank you for submitting your volunteer application! Our administration team is manually verifying your ID and Selfie to ensure a safe community.
                            <br /><br />
                            Please check back soon. We will update your account status once the review is complete.
                        </p>
                    </div>
                    ...
                    <div className="bg-red-50 rounded-[2rem] p-10 text-center border border-red-200 mt-8">
                        ...
                        <p className="text-gray-600 max-w-md mx-auto">
                            Unfortunately, your application to become a verified volunteer was declined by the administration team.
                    ...
                    <>
                        ...
                        {step < 4 && (
                            <div className="flex gap-2 mb-8 h-2">
                                {[1, 2, 3].map(i => (
                                    <div key={i} className={`flex-1 rounded-full ${step >= i ? 'bg-green-500' : 'bg-gray-200'}`} />
                                ))}
                            </div>
                        )}
                            ...
                            {step === 1 && (
                                <div className="space-y-6 animate-fade-in">
                                    ...
                                    <div>
                                        ...
                                        <input value={organization} onChange={e => setOrganization(e.target.value)} className="w-full p-4 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500" placeholder="NGO Registration # or Organization Name" />
                                    </div>
                                    <div>
                            ...
                            {step === 2 && (
                                <div className="space-y-8 animate-fade-in">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <input type="file" accept="image/*" onChange={(e) => handleImageUpload(e, setIdImage)} ref={idInputRef} className="hidden" />
                                        <div
                                        ...
                                        >
                                            {idImage ? (
                                                ...
                                                <div className="text-center text-gray-500 flex flex-col items-center">
                                                    <div className="bg-white p-3 rounded-full mb-3 shadow-sm"><Upload size={24} className="text-gray-600" /></div>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <input type="file" accept="image/*" capture="user" onChange={(e) => handleImageUpload(e, setSelfieImage)} ref={selfieInputRef} className="hidden" />
                                        <div
                                        ...
                                        >
                                            {selfieImage ? (
                                                ...
                                                <div className="text-center text-gray-500 flex flex-col items-center">
                                                    <div className="bg-white p-3 rounded-full mb-3 shadow-sm"><Camera size={24} className="text-gray-600" /></div>
                                ...
                                <div className="space-y-6 animate-fade-in">
                                    ...
                                    <div className="bg-gray-50 p-6 rounded-2xl text-sm text-gray-600 h-48 overflow-y-auto border border-gray-200">
                                        ...
                                        <ul className="list-disc pl-5 space-y-2">
                                            ...
                                            <li>Transport perishable foods in temperature-appropriate containers if required.</li>
                                            <li>Provide photo evidence of the food drop-off to close the donation loop.</li>
                                    ...
                                    <label className="flex items-start gap-3 cursor-pointer p-4 border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors">
                                        <input type="checkbox" checked={termsSigned} onChange={e => setTermsSigned(e.target.checked)} className="mt-1 w-5 h-5 text-green-600 rounded focus:ring-green-500" />
                                        <span className="font-medium text-gray-700">I have read and agree to the Safe Food Handling Terms of Conduct and acknowledge that violation may result in account termination.</span>
                                    </label>
                                    ...
                                    <div className="flex gap-4 pt-4">
                                        <button onClick={() => setStep(2)} className="w-1/3 py-4 bg-gray-100 text-gray-700 rounded-xl font-bold hover:bg-gray-200 transition-colors">Back</button>
                                        <button onClick={handleSubmit} disabled={isSubmitting} className="w-2/3 py-4 bg-green-600 text-white rounded-xl font-bold hover:bg-green-700 transition-colors disabled:bg-green-400">
                            ...
                            {step === 4 && (
                                <div className="text-center py-12 space-y-6 animate-fade-in">
                                    ...
                                    <p className="text-gray-500 max-w-sm mx-auto">
                                        Thank you for applying to be a volunteer. Our administrative team will review your application shortly.
                                    </p>
                                    <button onClick={() => navigate('/')} className="px-8 py-4 bg-black text-white rounded-xl font-bold hover:bg-gray-800 transition-colors mt-8">
                                        Return to Home
                                    </button>
                                </div>
                            )}
